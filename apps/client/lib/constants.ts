...
export const BASE_SERVER_URL = IS_DEV_ENV
  ? "http://localhost:3001"
  : "https://codex-server. v.dev";

export const STATUS_URL = "http://localhost:3000";
...
export const SITE_NAME = "Lunet - Collaborative Coding Platform";
export const SITE_DESCRIPTION =
  "Your collaborative coding space, reimagined. Code together now on Lunet, no sign-up required.";
...
export const LATENCY_TEST_DESCRIPTION =
  "Test your latency to the Lunet server.";
...
export const NAME = "  Vibulsanti";
export const PORTFOLIO_URL = " ";
export const CONTACT_URL = " /contact";
export const REPO_URL = "https://github.com/ v/codex";
export const GITHUB_URL = "https://github.com/ v";
